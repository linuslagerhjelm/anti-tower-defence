 ...
 * Created: 2016-12-6
 * Game screen where the level, unit and etc will be displayed for the user.
...
public class GameScreenPanel {
    ...
    private static final String DEFAULT_IMAGE =
            "/images/levels/default_level.png";
    ...
    /**
     * Constructor of game screen panel that creates an instance of a
     * game screen.
     *
...
//Creates Default things..
    ...
    /**
     * Draws a laser by adding it to the list of lasers to be drawn at every
     * frame.
     *
